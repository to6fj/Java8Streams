...
public class Question9 {
    public static void main(String[] args) {
        ...
        Employee emp2  = new Employee(24253, "Amit Sharma", "HR", 4000.00);
        ...
        employees.stream().sorted((e1,e2)->Double.compare(e1.salary(),e2.salary())).findFirst().ifPresent(System.out::println);
    }
}
